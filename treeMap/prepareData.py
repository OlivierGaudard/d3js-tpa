...
processData = processData[processData['sexe'] != '?']
processData = processData[processData['situationFamiliale'] != '?']
processData = processData[processData['nbEnfantsAcharge'] != '?']
processData = processData[processData['nbEnfantsAcharge'] != '-1']
processData = processData[processData['nbEnfantsAcharge'] != ' ']


print('SEXE')
print(processData['sexe'].unique())
...
print("MARQUES : ")
print(processData['marque'].unique())

print("COULEURS : ")
print(processData['couleur'].unique())

print("NB ENFANTS")
print(processData['nbEnfantsAcharge'].unique())
